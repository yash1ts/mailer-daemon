...
class ContactFragmentViewPager : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        view.tab_layout.setupWithViewPager(view.contact_viewpager)
        view.tab_layout.tabMode = TabLayout.MODE_SCROLLABLE
        val tabs = arguments?.getStringArray("tabs")
        view.contact_viewpager.adapter = object:FragmentStatePagerAdapter(childFragmentManager, FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
